...
@CrossOrigin(origins = {"http://localhost:4200", "http://localhost:8100", "*"}, allowedHeaders = "*", methods = {RequestMethod.GET, RequestMethod.POST, RequestMethod.PUT, RequestMethod.DELETE})
